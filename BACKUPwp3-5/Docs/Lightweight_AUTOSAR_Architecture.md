...
- `App`: application logic and cyclic runnable.
  ...
  - `App.c` periodically samples ADC, updates LCD1602, handles UART commands, drives AT24C02 read/write jobs, displays IR remote keys, and writes IR key bits to the 8-bit LED latch.
